...
# Continual window
# poetry run python -m project.main --config-name=cluster_cifar_flash fed.seed=5378 task.sparsity=0.950 task.fit_config.run_config.learning_rate=0.5 task.fit_config.run_config.final_learning_rate=0.01 fed.num_rounds=700 strategy=fedavgCFLASH dataset.num_classes=10 dataset.lda_alpha=1.0 wandb.setup.project=continual_learning task.eval_config.extra.window_training=True dataset=cluster_cifar_clustered_lda


# mask test
poetry run python -m project.main --config-name=cluster_cifar_flash fed.seed=2035 task.sparsity=0.990 task.fit_config.run_config.learning_rate=0.5 task.fit_config.run_config.final_learning_rate=0.01 fed.num_rounds=700 strategy=fedavgFLASH dataset.num_classes=10 dataset.lda_alpha=0.1 wandb.setup.project=cleaning
