...
# poetry run python -m project.main --config-name=cluster_cifar_resnet18 fed.seed=9421 task.fit_config.run_config.learnin# g_rate=0.5 task.fit_config.run_config.final_learning_rate=0.01 fed.num_rounds=700 dataset.lda_alpha=1000.0
