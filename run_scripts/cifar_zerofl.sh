...
poetry run python -m project.main --config-name=cluster_cifar_zerofl fed.seed=5378 task.alpha=1.0 task.sparsity=0.999 task.fit_config.run_config.learning_rate=0.5 task.fit_config.run_config.final_learning_rate=0.01 fed.num_rounds=700 strategy=fedavgNZ dataset.num_classes=100 dataset.lda_alpha=0.1
poetry run python -m project.main --config-name=cluster_cifar_zerofl fed.seed=9421 task.alpha=1.0 task.sparsity=0.999 task.fit_config.run_config.learning_rate=0.5 task.fit_config.run_config.final_learning_rate=0.01 fed.num_rounds=700 strategy=fedavgNZ dataset.num_classes=100 dataset.lda_alpha=0.1
poetry run python -m project.main --config-name=cluster_cifar_zerofl fed.seed=2035 task.alpha=1.0 task.sparsity=0.999 task.fit_config.run_config.learning_rate=0.5 task.fit_config.run_config.final_learning_rate=0.01 fed.num_rounds=700 strategy=fedavgNZ dataset.num_classes=100 dataset.lda_alpha=0.1
