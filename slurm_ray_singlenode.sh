...
# srun python main.py -m fl_setting.local_epochs=1 ray_config.gpus_per_client=0.1 model=swat model.init_model_fn.sparsity=0.1,0.2,0.5,0.6,0.8,0.9 model.init_model_fn.alpha=1

# srun python main.py -m fl_setting.local_epochs=1 ray_config.gpus_per_client=0.1 model=swat model.init_model_fn.sparsity=0.1,0.2,0.5,0.6,0.8,0.9 model.init_model_fn.alpha=2

srun python main.py -m fl_setting.local_epochs=1 ray_config.gpus_per_client=0.1 model=swat model.init_model_fn.sparsity=0.1,0.2,0.5,0.6,0.8,0.9 model.init_model_fn.alpha=4
