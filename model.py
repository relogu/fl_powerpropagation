...
from powerprop_modules import PowerPropConv2D, init_weights
...
def replace_conv_with_powerprop(
    ...
    """Replace every torch.nn.Conv2d layer with PowerPropConv2D"""
...
def get_parameters_to_prune(
    ...
    def add_immediate_child(
        ...
        if type(module) == PowerPropConv2D:
            parameters_to_prune.append((module, "w"))
